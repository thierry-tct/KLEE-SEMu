...
const Module *Executor::setModule(llvm::Module *module, 
  ...
  // @KLEE-SEMu
#if SEMU_ENABLED_MACRO == 1
  semuEHelper.ks_initializeModule(module, opts);
#endif
  //~KS
  ...
  // @KLEE-SEMu
#if SEMU_ENABLED_MACRO == 1
  semuEHelper.ks_verifyModule(module);
#endif
  //~KS
...
void Executor::run(ExecutionState &initialState) {
  ...
  if (ExecutionStateHelperSemu::ks_getMode() == ExecutionStateHelperSemu::KS_Mode::SEMU_MODE) {
    ...
    semuEHelper.ks_runStartTime = util::getWallTime();
...
void Executor::callExternalFunction(ExecutionState &state,
  ...
  if (semuEHelper.cfgSemuForkProcessForSegvExternalCalls && function->getName() == "printf") {
    pid_t my_pid;
    int child_status;
