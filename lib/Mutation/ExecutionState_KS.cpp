...
ExecutionState::ExecutionState(const std::vector<ref<Expr> > &assumptions)
    : constraints(assumptions), queryCost(0.), ptreeNode(0), 
      ...
      ks_hasToReachPostMutationPoint(false), ks_startdepth(0), ks_numberOfOutEnvSeen(0),
      ks_numberActiveCmpMutants(0) /*//~KS*/ {}
...
int ExecutionState::ks_compareStateWith (const ExecutionState &b, llvm::Value *MutantIDSelectDeclIns, 
  ...
  #endif
            ref<Expr> tmpexpr = NeExpr::create(ks_lastReturnedVal, b.ks_lastReturnedVal);
