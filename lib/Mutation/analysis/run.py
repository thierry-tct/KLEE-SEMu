...
def main():
    ...
    parser.add_argument("--semumutantcontinuestrategy", type=str, default='mdo', choices=['mdo', 'rnd'], help="Specify the space separated list of the trategies to use to continue mutants after watchpoint in test generation mode. Currently the strategies are min distance to output(mdt) and random(rnd).")
